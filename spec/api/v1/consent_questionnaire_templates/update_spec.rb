...
RSpec.describe "consent_questionnaire_templates#update", type: :request do
  subject(:make_request) do
    jsonapi_put "/api/v1/consent_questionnaire_templates/#{consent_questionnaire_template.id}", payload
  end
