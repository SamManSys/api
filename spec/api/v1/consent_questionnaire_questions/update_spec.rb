...
RSpec.describe "consent_questionnaire_questions#update", type: :request do
  subject(:make_request) do
    jsonapi_put "/api/v1/consent_questionnaire_questions/#{consent_questionnaire_question.id}", payload
  end
