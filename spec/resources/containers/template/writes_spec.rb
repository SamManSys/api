...
RSpec.describe Containers::TemplateResource, type: :resource do
  describe 'creating' do
    ...
    let(:instance) do
      Containers::TemplateResource.build(payload)
    end
  ...
  describe 'updating' do
    ...
    let(:instance) do
      Containers::TemplateResource.find(payload)
    end
  ...
  describe 'destroying' do
    ...
    let(:instance) do
      Containers::TemplateResource.find(id: storage_container_template.id)
    end
